...
\subsection{Old and new problems}
    ...
    In this sense, ML systems even have a better potential to solve the problem, using for example importance weighting or under-/over-sampling \cite[pp.~6-8]{Chen2021} or by driving the collection of more diversified data \cite{Zerilli2019}.
    ...
    Although it is true that personalization might be an illusion, ML allows for more precise groupings \idea{[citation needed: Binns2018]}.
